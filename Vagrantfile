...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.box = "vagrant-fit14-devbox-14.0.3-c1-0"
  config.vm.box_url = "https://#{download_creds}download.sevenval-fit.com/fit-devbox/14/images/vagrant-fit14-devbox-14.0.3-c1-0.box"
  config.vm.box_download_checksum = "362cb2aea4379107bd7d7f920c6652413f79aa86"
