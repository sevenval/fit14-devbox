...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  config.vm.box = "vagrant-fit14-devbox-14.1.0-0"
  config.vm.box_url = "https://#{download_creds}download.sevenval-fit.com/fit-devbox/14/images/vagrant-fit14-devbox-14.1.0-0.box"
  config.vm.box_download_checksum = "260167085f4a2e843eacc2e0f13fdf1bed2b2cb1"
